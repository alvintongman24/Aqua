...
export default function Footer() {
  return (
    <footer className="mx-auto md:p-5 bg-white text-black text-[8px] md:text-sm lg:text-md">
     ...
     <section className="text-center p-4 bg-white rounded-t-lg shadow-inner border-t border-gray-200 pt-20 ">
     <div className="mb-2">
      <div className="flex justify-center items-centermb-2">
        <img src="logo.png" width="40px" height="40px" alt="Aqua Foundation Logo" />
...
<div class="parent">
  ...
  <div class="child child-4">
    <button class="buttonr btn-4">
      <a href="https://www.facebook.com/aqua_foundation_wop" target="_blank" rel="noopener noreferrer">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="1em"
        viewBox="0 0 320 512"
      ...
      <p className="text-[8px] md:text-sm lg:text-md">
        &copy; {new Date().getFullYear()} Aqua Foundation. All rights reserved.
      </p>
     </section>
    </footer>
  );
