      ...
      return (
        ...
        <div class="bg-purple-100/50 rounded-2xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                <motion.div initial={{ opacity: 0, x: 100 }}  variants={container} animate={{ opacity: 1, x: 0 }} transition={{ duration: 2 }} class="text-center p-6 rounded-xl bg-blue-50" >
                    <div class="text-blue-500 text-3xl mb-4">
                        
                    </div>
                    <h3 class="font-semibold text-lg mb-2 text-black flex justify-center items-center"> <GraduationCap className="text-purple-600 w-8 h-8" />Mission Statement</h3>
                ...
                <motion.div initial={{ opacity: 0, translateX:"-100%" }}  variants={container} animate={{ opacity: 1, translateX: 0 }} transition={{ duration: 2 }} class="text-center p-6 rounded-xl bg-purple-50">
                    <div class="text-purple-500 text-3xl mb-4">
                        <i class="fas fa-expand"></i>
                    </div>
                    <h3 class="font-semibold text-lg mb-2 text-black flex justify-center items-center"><Briefcase className="w-8 h-8 text-purple-600" />Vision Statement</h3>
                ...
                < motion.div initial={{ opacity: 0, x: 100 }}  variants={container} animate={{ opacity: 1, x: 0 }} transition={{ duration: 2 }}  class="text-center p-6 rounded-xl bg-teal-50">
                    <div class="text-teal-500 text-3xl mb-4">
                        <i class="fas fa-mobile-alt"></i>
                    </div>
                    <h3 class="font-semibold text-lg mb-2 text-black flex justify-center items-center"><Globe className="w-8 h-8 text-purple-600" title="Global community" />Our Community</h3>
